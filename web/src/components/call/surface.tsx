...
export function ConsoleCard({
  ...
  return (
    <section
      className={`rounded-[13px] border border-slate-200/90 bg-white shadow-[0_1px_2px_rgba(15,23,42,0.04),0_4px_16px_-8px_rgba(15,23,42,0.10)] ${className}`}
    >
      {children}
    </section>
  );
...
export function CardHeading({
  ...
  return (
    ...
    <div className={`flex h-[26px] items-center justify-between gap-3 ${className}`}>
      <h2 className="text-[15px] leading-5 font-semibold tracking-[-0.01em] text-slate-900">{title}</h2>
